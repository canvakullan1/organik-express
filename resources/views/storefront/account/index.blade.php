...
<div class="mx-auto max-w-5xl px-4 py-10">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
        ...
        <form method="POST" action="{{ route('logout') }}">
            @csrf
            <button type="submit" class="btn-ghost !rounded-full">Çıkış Yap</button>
        </form>
    </div>
    ...
    <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
        @php
            $cards = [
                ...
                ['Bilgilerim', 'Ad, e-posta, şifre', 'M15.75 6a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0ZM4.501 20.118a7.5 7.5 0 0 1 14.998 0A17.933 17.933 0 0 1 12 21.75c-2.676 0-5.216-.584-7.499-1.632Z', route('account.profile'), 'Düzenle'],
                ['İletişim İzinleri', 'E-bülten ve bildirim tercihleri', 'M14.857 17.082a23.848 23.848 0 0 0 5.454-1.31A8.967 8.967 0 0 1 18 9.75V9A6 6 0 0 0 6 9v.75a8.967 8.967 0 0 1-2.312 6.022c1.733.64 3.56 1.085 5.455 1.31m5.714 0a24.255 24.255 0 0 1-5.714 0m5.714 0a3 3 0 1 1-5.714 0', route('account.preferences'), 'Yönet'],
            ];
        @endphp

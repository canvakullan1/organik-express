        ...
        <div class="mt-auto pt-3">
            ...
            @if($variant)
                <form action="{{ route('cart.add') }}" method="POST" class="mt-3"
                    ...
                    <button type="submit" class="flex w-full items-center justify-center gap-2 rounded-lg bg-leaf-600 py-2.5 text-sm font-700 text-white transition hover:bg-leaf-700 active:scale-[0.98]">
